 ...
 * @note     Generated by SVDConv V3.2.66 on Thursday, 06.09.2018 11:47:39
 *           from File 'ADuCM350.svd',
 *           last modified on Thursday, 06.09.2018 02:17:37
 */
...
typedef struct {                                /*!< (@ 0x40000400) ADI_GPT1 Structure                                         */
  __IOM uint16_t  REG_TMR1_LOAD;                /*!< (@ 0x00000000) 16-bit load value                                          */
  __IM  uint16_t  RESERVED;
  __IOM uint16_t  REG_TMR1_CURCNT;              /*!< (@ 0x00000004) 16-bit timer value                                         */
  __IM  uint16_t  RESERVED1;
  __IOM uint16_t  REG_TMR1_CTL;                 /*!< (@ 0x00000008) Control Register                                           */
  __IM  uint16_t  RESERVED2;
  __IOM uint16_t  REG_TMR1_CLRINT;              /*!< (@ 0x0000000C) Clear interrupt register                                   */
  __IM  uint16_t  RESERVED3;
  __IOM uint16_t  REG_TMR1_CAPTURE;             /*!< (@ 0x00000010) Capture                                                    */
  __IM  uint16_t  RESERVED4;
  __IOM uint16_t  REG_TMR1_ALOAD;               /*!< (@ 0x00000014) 16-bit load value, asynchronous                            */
  __IM  uint16_t  RESERVED5;
  __IOM uint16_t  REG_TMR1_ACURCNT;             /*!< (@ 0x00000018) 16-bit timer value, asynchronous                           */
  __IM  uint16_t  RESERVED6;
  __IOM uint16_t  REG_TMR1_STATUS;              /*!< (@ 0x0000001C) Status Register                                            */
  __IM  uint16_t  RESERVED7;
  __IOM uint16_t  REG_TMR1_PWMCTL;              /*!< (@ 0x00000020) PWM Control Register                                       */
  __IM  uint16_t  RESERVED8;
  __IOM uint16_t  REG_TMR1_PWMMATCH;            /*!< (@ 0x00000024) PWM Match Value                                            */
...
typedef struct {                                /*!< (@ 0x40000800) ADI_GPT2 Structure                                         */
  __IOM uint16_t  REG_TMR2_LOAD;                /*!< (@ 0x00000000) 16-bit load value                                          */
  __IM  uint16_t  RESERVED;
  __IOM uint16_t  REG_TMR2_CURCNT;              /*!< (@ 0x00000004) 16-bit timer value                                         */
  __IM  uint16_t  RESERVED1;
  __IOM uint16_t  REG_TMR2_CTL;                 /*!< (@ 0x00000008) Control Register                                           */
  __IM  uint16_t  RESERVED2;
  __IOM uint16_t  REG_TMR2_CLRINT;              /*!< (@ 0x0000000C) Clear Interrupt register                                   */
  __IM  uint16_t  RESERVED3;
  __IOM uint16_t  REG_TMR2_CAPTURE;             /*!< (@ 0x00000010) Capture                                                    */
  __IM  uint16_t  RESERVED4;
  __IOM uint16_t  REG_TMR2_ALOAD;               /*!< (@ 0x00000014) 16-bit load value, asynchronous                            */
  __IM  uint16_t  RESERVED5;
  __IOM uint16_t  REG_TMR2_ACURCNT;             /*!< (@ 0x00000018) 16-bit timer value, asynchronous                           */
  __IM  uint16_t  RESERVED6;
  __IOM uint16_t  REG_TMR2_STATUS;              /*!< (@ 0x0000001C) Status                                                     */
  __IM  uint16_t  RESERVED7;
  __IOM uint16_t  REG_TMR2_PWMCTL;              /*!< (@ 0x00000020) PWM Control Register                                       */
  __IM  uint16_t  RESERVED8;
  __IOM uint16_t  REG_TMR2_PWMMATCH;            /*!< (@ 0x00000024) PWM Match Value                                            */
...
typedef struct {                                /*!< (@ 0x40002420) ADI_EI Structure                                           */
  __IOM uint16_t  REG_PWR_EI0CFG;               /*!< (@ 0x00000000) PWR External Interrupt configuration 0                     */
  __IM  uint16_t  RESERVED;
  __IOM uint16_t  REG_PWR_EI1CFG;               /*!< (@ 0x00000004) PWR External Interrupt configuration 1                     */
  __IM  uint16_t  RESERVED1;
  __IOM uint16_t  EI2CFG;                       /*!< (@ 0x00000008) PWR External Interrupt configuration 2                     */
  __IM  uint16_t  RESERVED2[3];
  __IOM uint16_t  REG_PWR_EICLR;                /*!< (@ 0x00000010) PWR External Interrupt clear                               */
  __IM  uint16_t  RESERVED3;
  __IOM uint16_t  REG_PWR_NMICLR;               /*!< (@ 0x00000014) PWR Non-maskable interrupt clear                           */
  __IM  uint16_t  RESERVED4;
  __IOM uint16_t  REG_PWR_USBWKSTAT;            /*!< (@ 0x00000018) PWR USB Wakeup Status                                      */
  __IM  uint16_t  RESERVED5[3];
  __IOM uint16_t  REG_PWR_RSTSTA;               /*!< (@ 0x00000020) PWR Reset status                                           */
...
typedef struct {                                /*!< (@ 0x40002480) ADI_PWRVCC Structure                                       */
  ...
  __IOM uint16_t  REG_PWR_VCCMCON;              /*!< (@ 0x00000008) PWR VCCM Control and Status                                */
  __IM  uint16_t  RESERVED1;
  __IOM uint16_t  REG_PWR_VBACKCON;             /*!< (@ 0x0000000C) PWR VBACK control and status                               */
...
typedef struct {                                /*!< (@ 0x400A0000) ADI_USB Structure                                          */
  ...
  __IOM uint32_t  REG_USB0_RAM_ADDR;            /*!< (@ 0x000003B0) USB0 RAM Address Register                                  */
  __IOM uint32_t  REG_USB0_RAM_DATA;            /*!< (@ 0x000003B4) USB0 RAM Data Register                                     */
...
#define ADI_GPIO2_BASE              0x40020090UL
