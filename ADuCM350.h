 ...
 * @note     Generated by SVDConv V3.2.66 on Wednesday, 12.09.2018 16:47:54
 *           from File 'ADuCM350.svd',
 *           last modified on Wednesday, 12.09.2018 07:17:13
 */
...
typedef struct {                                /*!< (@ 0x40005C00) ADI_BEEP Structure                                         */
  __IOM uint16_t  CFG;                          /*!< (@ 0x00000000) BEEP Beeper configuration                                  */
  __IM  uint16_t  RESERVED;
